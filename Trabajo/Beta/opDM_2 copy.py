...
# Copias y transformaciones de las ruedas delanteras
rueda_delantera_derecha_copia2 = transform_and_plot(rueda_delantera_izquierda, [1.3, -0.1, -1.2], Rz @ Ry @ Rx @ translate([5.0, 0.0, 0.0]))

# Copias y transformaciones de las ruedas delanteras
rueda_trasera_izquierda_copia2 = transform_and_plot(rueda_delantera_izquierda, [-1.4, -0.1, 1.2], Rz @ Ry @ Rx @ translate([5.0, 0.0, 0.0]))

# Copias y transformaciones de las ruedas delanteras
rueda_trasera_delantera_copia2 = transform_and_plot(rueda_delantera_izquierda, [-1.4, -0.1, -1.2], Rz @ Ry @ Rx @ translate([5.0, 0.0, 0.0]))
