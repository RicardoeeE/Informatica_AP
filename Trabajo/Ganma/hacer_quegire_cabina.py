...
def main():
    ...
    #  Giro al final del desplazamiento recto
    posicion_final_rectilineo = [66.0, 0.0, 0.0]
    ...
    for step_giro in range(n_steps_giro):
        ...
        # Traslada a la posición final de la línea recta
        tl_final_rectilineo = translacion(posicion_final_rectilineo)

        # Aplica la rotación justo después de la translación
        tf_cabina = tl_final_rectilineo @ rotate_y(angulo_giro) @ (Rz @ Ry @ Rx)
        tf_ruedas = tl_final_rectilineo @ rotate_y(angulo_giro) @ Rz @ Ry @ Rx
